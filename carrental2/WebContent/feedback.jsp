...
<div class="header-bg">
	<div class="wrap">
		    ...
		    <div class="section group">
				<div class="col span_2_of_c">
				  <div class="contact-form">
				  	<h3>Feedback</h3>
					    <form id="feedback-form" action="servlet/Feedback" method="post"  role="form" style="display: block;">
					    	<div>
						    	<span><label>NAME</label></span>
						    	<span><input name="name" type="text" class="textbox" value=""></span>
				
						    </div>
					<div>
						    	
						    	<span><textarea type="text" name="feedback"  row="4" cols="80" placeholder="Insert your comment about our services" class="textbox" value=""></textarea></span>
						    </div>	
						<br>
								<div>
						   		<span><input type="submit" name="feedback-submit" value="Submit"></span>
		 </div>
					    </form>
				  </div>
		...
		<div class="footer-bottom">
			<div class="copy">
				<p>Copyright &copy; Car Rental System</p>
			</div>
		</div>
</div>
</div>
